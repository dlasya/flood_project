  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const merged = {
        ...
        state: api.state,
        annual_rainfall: api.annual_rainfall !== undefined ? api.annual_rainfall : 0,
        elevation: api.elevation !== undefined ? api.elevation : 0,
        soil_type: api.soil_type || "Unknown",
        drainage_quality: api.drainage_quality || "Not Available",
